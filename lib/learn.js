...
export const LEARN = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How long should implementation take?", a: "For a platform that fits the model, 60 days including migration, training and sign-off is realistic. Longer usually means configuration bloat or poor fit." },
    ],
