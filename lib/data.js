...
export const COMPANY = {
  ...
  support: "sales@intermediateds.co.za",
  phone: "+27 11 676 6884",
  address: {
    street: "140 West Street, TBE",
...
export const SITE_URL = "https://oneapex.co.za";
...
export const TRUST_SIGNALS = [
  ...
  { value: "0", label: "development needed to go live" },
...
export const IMPLEMENTATION = [
  ...
  {
    step: "5",
    title: "You go live once your book is onboarded — with a 90-day warranty",
    body: "The platform is already built and live in production — there's no development project left to wait on. Once validation is signed off, you go live on your book, with a 90-day defects liability period after every deployment. We stay on-site until your team is running it without us.",
  },
];
...
export const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      "White-glove onboarding, 90-day warranty",
    ],
    highlight: false,
  },
];
...
export const FUND_PARTNER = {
  ...
  stats: [
    ...
    { value: "0", label: "development needed to deploy an originator" },
  ],
};
